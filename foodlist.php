...
<html>
  ...
  <head>
    <title> Explore Food | Victory Tech </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="OrderModule/Order.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart  (<?php
...
<form method="post" action="OrderModule/OrderController.php?action=add&id=<?php echo $row["F_ID"]; ?>">
