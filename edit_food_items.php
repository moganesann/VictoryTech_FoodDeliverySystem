...
<html>
  ...
  <head>
    <title> Manager Login | Victory Tech </title>
  </head>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="RestaurantModule/myrestaurant.php" class="list-group-item ">My Restaurant</a>
			...
			<a href="ContactModule/view_contact.php" class="list-group-item ">View Contact Details</a>
			<a href="RestaurantModule/ViewRestaurant.php" class="list-group-item ">View Restaurant Details</a>
			<a href="PaymentModule/viewPayment.php" class="list-group-item ">View Payment Details</a>
    	</div>
    </div>
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Food Price (MY)" required="">
          </div>
