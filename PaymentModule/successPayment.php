...
$sql = "SELECT MAX(Payment_ID) AS id FROM PAYMENT"; 
...
<h2 class="text-center"> Thank you for Ordering at Victory Tech! The ordering process is now complete.</h2>
...
<h3 class="text-center"> <strong>Your Payment ID:</strong> <span style="color: g;"><?php echo $payment_id; ?></span> </h3>
<h3 class="text-center"> <strong>Your Transaction Number:</strong> <span style="color: blue;"><?php echo "$number"; ?></span> </h3> 
