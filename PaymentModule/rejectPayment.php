...
?>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center" style="color: red;"><span class="glyphicon glyphicon-ok-circle"></span> Order Unsuccessful.</h1>
          </div>
        </div>
        <br>

<h2 class="text-center"> Sorry for the inconvenience.Your payment is rejected. </h2>
