...
<html>
  ...
  <head>
    <title> Contact | Victory Tech </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Victory Tech </span>?</strong>
     <br>
      ...
      <div class="form-area">
       <form action="ContactController.php" method="POST">
        <br style="clear: both">
          ...
          <a href="ContactController.php"><input type="submit" name="submit" type="button" id="submit" name="submit" class="btn btn-primary pull-right"/>    
        </form>
